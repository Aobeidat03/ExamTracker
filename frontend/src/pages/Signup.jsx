...
function InputField({ label, name, type = 'text', placeholder, autoComplete, value, onChange, error }) {
  return (
    <div>
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12 bg-gray-50">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <p className="text-gray-500 text-sm mb-6">Start tracking your exams in seconds</p>
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-4">
              <InputField label="Full name" name="name" placeholder="Jane Smith" autoComplete="name" value={form.name} onChange={handleChange} error={fieldErrors.name} />
              <InputField label="Email address" name="email" type="email" placeholder="you@university.edu" autoComplete="email" value={form.email} onChange={handleChange} error={fieldErrors.email} />
              <InputField label="Password" name="password" type="password" placeholder="Min. 8 characters" autoComplete="new-password" value={form.password} onChange={handleChange} error={fieldErrors.password} />
              <InputField label="Confirm password" name="confirm" type="password" placeholder="Re-enter password" autoComplete="new-password" value={form.confirm} onChange={handleChange} error={fieldErrors.confirm} />
